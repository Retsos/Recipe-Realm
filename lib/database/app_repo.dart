...
class AppRepository extends ChangeNotifier {
  ...
  /// New method to explicitly add a favorite recipe with logging
  ...
  /// New method to explicitly remove a favorite recipe with logging
  ...
  Future<void> updateSetting(UserSettingEntity setting) async {
    try {
      // Use the insertOrUpdateSetting method which uses OnConflictStrategy.replace
  ...
  bool? _getBoolSetting(
      List<UserSettingEntity> settings, String key) {
    try {
      return settings
